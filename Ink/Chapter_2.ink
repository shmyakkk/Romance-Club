...
- else:
    ...
    ГГ (base): Как ответить?
        ...
        * [Я всегда была везучей.]
            ...
            Карл: То-то я и смотрю, везучая какая. В кофейне полы моешь.
            ГГ (surprise): …
...
Мартин (без спрайта): Алло?
..: Ты помедлила, осознав, что не знаешь, как начать разговор.
Мартин (без спрайта): Кто это?
ГГ (base): Это (имя гг). Вы дали мне свою визитку сегодня в кофейне.
Мартин (без спрайта): Да-да, помню.
Мартин (без спрайта): Что-то случилось? Уже довольно поздно.
...
Мартин (без спрайта): (имя гг), вы плачете?
ГГ (sad): Я… нет…
..: Ты никак не могла совладать с обрушившимися на тебя эмоциями.
Мартин(без спрайта): Я слышу, что да. Давайте поступим следующим образом.
..: Его строгий голос вселял в тебя какое-то подобие надежды.
Мартин(без спрайта): Вызовите себе такси и приезжайте по адресу, который я пришлю вам в мессенджере.
ГГ (sad): Хорошо. Спасибо.

{is_tell_true: 
    ~ respect_Martin = respect_Martin + 1
    ..: Прежде чем попрощаться, он добавил.
    Мартин(без спрайта): Не плачьте. Мы со всем разберемся.
...
…: Как поступить?
    ...
    * [выбрать отель]
        ...
        ГГ: Проверяешь время по старинке, пока держишь в руках телефон?
        Мартин (smile): …
